...
void BBCar::stop_normp(){
    servo0.set_factor(1);
    servo1.set_factor(1);
    servo0.set_speed_normp(0);
    servo1.set_speed_normp(0);
}
...
void BBCar::goStraight_normp( double speed ){\
    servo0.set_factor(1);
    servo1.set_factor(1);
    servo0.set_speed_normp(speed);
    servo1.set_speed_normp(-speed);
}
...
void BBCar::goStraightCalib_normp ( double speed ){
    servo0.set_factor(0.9);
    servo1.set_factor(1);
    servo0.set_speed_by_cm_normp(speed);
    servo1.set_speed_by_cm_normp(-speed);
}
